...
const fr = {
  ...
  "update.section": "Mises à jour", "update.currentVersion": "Version installée : {version}", "update.check": "Rechercher les mises à jour", "update.checking": "Recherche en cours…", "update.available": "Version {version} disponible.",
  "update.downloading": "Téléchargement de la version {version} : {percent}%", "update.upToDate": "Clipéo est à jour.", "update.error": "La recherche a échoué.", "update.installNow": "Installer et redémarrer",
  "update.checkError": "Impossible de vérifier les mises à jour. Vérifiez votre connexion puis réessayez.", "update.packagedOnly": "La recherche de mises à jour est disponible dans la version installée.",
...
const en: Catalog = {
  ...
  "update.section":"Updates","update.currentVersion":"Installed version: {version}","update.check":"Check for updates","update.checking":"Checking for updates…","update.available":"Version {version} is available.","update.downloading":"Downloading version {version}: {percent}%","update.upToDate":"Clipéo is up to date.","update.error":"The update check failed.","update.installNow":"Install and restart","update.checkError":"Unable to check for updates. Check your connection and try again.","update.packagedOnly":"Update checks are available in the installed version.",
...
const es: Catalog = {
  ...
  "update.section":"Actualizaciones","update.currentVersion":"Versión instalada: {version}","update.check":"Buscar actualizaciones","update.checking":"Buscando actualizaciones…","update.available":"La versión {version} está disponible.","update.downloading":"Descargando la versión {version}: {percent}%","update.upToDate":"Clipéo está actualizado.","update.error":"La búsqueda de actualizaciones falló.","update.installNow":"Instalar y reiniciar","update.checkError":"No se pudieron buscar actualizaciones. Comprueba tu conexión e inténtalo de nuevo.","update.packagedOnly":"La búsqueda de actualizaciones está disponible en la versión instalada.",
...
const de: Catalog = {
  ...
  "update.section":"Aktualisierungen","update.currentVersion":"Installierte Version: {version}","update.check":"Nach Aktualisierungen suchen","update.checking":"Aktualisierungen werden gesucht…","update.available":"Version {version} ist verfügbar.","update.downloading":"Version {version} wird heruntergeladen: {percent}%","update.upToDate":"Clipéo ist aktuell.","update.error":"Die Aktualisierungssuche ist fehlgeschlagen.","update.installNow":"Installieren und neu starten","update.checkError":"Aktualisierungen konnten nicht geprüft werden. Verbindung prüfen und erneut versuchen.","update.packagedOnly":"Die Aktualisierungssuche ist in der installierten Version verfügbar.",
